...
+ (NSSet*) restorePaymentsWithTimeout:(NSTimeInterval) timeout error:(NSError**) error {
	return [[[LolayVenderePaymentRequest alloc] init] restorePaymentsWithTimeout:timeout error:error];
}

- (NSSet*) restorePaymentsWithError:(NSError**) error {
	return [self restorePaymentsWithTimeout:LolayVenderePaymentRequestDefaultTimeout error:error];
}

+ (NSSet*) restorePaymentsWithError:(NSError**) error {
	return [LolayVenderePaymentRequest restorePaymentsWithTimeout:LolayVenderePaymentRequestDefaultTimeout error:error];
}
